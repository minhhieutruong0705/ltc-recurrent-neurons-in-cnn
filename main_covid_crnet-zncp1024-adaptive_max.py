...
if __name__ == '__main__':
    training_name = "covid_crnet-zncp1024adamax"
    shuffler_version = 7
    ...
    model = CRNetNCP_ZRNN(  # custom version of crnet-zncp (adaptive sensory neurons: 27*27 -> 1024)
        in_channels=in_channels,
        ncp_spatial_dim=27,  # RNN features: 27*27=729 < 1024; adaptive enhance number of features

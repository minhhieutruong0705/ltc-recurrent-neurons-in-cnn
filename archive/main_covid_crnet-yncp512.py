...
if __name__ == '__main__':
    # record files
    training_name = "covid_crnet-yncp512"
    ...
    ).cuda()  # ncp: 16*32 -> 48 (-> 24 -> 4); classification: 16*4 -> 2
    print(model)
    ...
    train_covid_file = "../../datasets/Dataset_Covid/covid_train.txt"
    train_non_covid_file = "../../datasets/Dataset_Covid/normal_train.txt"
    val_covid_file = "../../datasets/Dataset_Covid/covid_validation.txt"
    val_non_covid_file = "../../datasets/Dataset_Covid/normal_validation.txt"
    test_covid_file = "../../datasets/Dataset_Covid/covid_test.txt"
    test_non_covid_file = "../../datasets/Dataset_Covid/normal_test.txt"

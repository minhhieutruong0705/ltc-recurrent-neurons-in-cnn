...
if __name__ == '__main__':
    ...
    # record_dir = "records/covid_3/covid_crnet-4fc_3"
    ...
    # record_dir = "records/covid_1/covid_crnet-pncp32-slide-horzig_1"

    # record_dir = "records/covid_1/covid_crnet-yncp32_1
    # record_dir = "records/covid_3/covid_crnet-yncp32_3"

    # record_dir = "records/covid_1/covid_crnet-yncp1024ada_1"

    # record_dir = "records/covid_1/covid_crnet-zncp32_1"
    # record_dir = "records/covid_3/covid_crnet-zncp32_3"
